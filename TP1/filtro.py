...
class RaisedCosineFilter: #creas la clase y le definies los parametros 
    def __init__(self, alpha=0.25, span=6, sps=8, rrc=True):
        ...
        self.sps = sps
        self.rrc = rrc
        self.taps = self._generate_filter() #le decis que apenas se inicialice llame a esta funcion para sacar los valores
